...
class SimpleDisplay(GraphWin):
    ...
    def toCoords(self, x, y):
        ...
        return x*self.scale, y*self.scale, (x+1)*self.scale, (y+1)*self.scale
    
    def plot(self, x, y, color="black"):
        """Set pixel (x,y) to the given color"""
        self.__checkOpen__()
        xt0,yt0,xt1,yt1 = self.toCoords(x,y)
        xst0,yst0 = self.toScreen(xt0,yt0)
        xst1,yst1 = self.toScreen(xt1,yt1)
        self.create_rectangle(xst0,yst0,xst1,yst1, fill=color, outline=color)
    ...
    def plotPixel(self, x, y, color="black"):
        ...
        self.__checkOpen__()
        xt0,yt0,xt1,yt1 = self.toCoords(x,y)
        self.create_rectangle(xt0,yt0,xt1,yt1, fill=color, outline=color)
        self.__autoflush__()
